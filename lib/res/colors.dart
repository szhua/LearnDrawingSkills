...
class Colours {
  ...
  static const Color bg_black = Color(0xFF000000);

  static const Color bg_color_app = Color(0xFFF2F2F2);

  static const Color color_divider = Color(0xFFF2F2F2);

  static const Color color_text_item_title = Color(0xFF545454);
  static const Color color_text_item_content = Color(0xFF656565);

  static const Color color_text_title = Color(0xFF444444);
  static const Color color_text_sub_title = Color(0xFF666666);


  static const Color color_green =Color(0xFF609d4e);
  static const Color light_blue = Color(0xFFebf3fc);
